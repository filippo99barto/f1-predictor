...
class GoldSchemaRaceResults(pa.DataFrameModel):
    ...
    driver_season_median_position: Series[float] = pa.Field(ge=1, nullable=True)
    driver_positions_gained_season_median: Series[float] = pa.Field(nullable=True)
    driver_positions_gained_career_median: Series[float] = pa.Field(nullable=True)
