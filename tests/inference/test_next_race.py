...
@patch("src.inference.next_race.load_race_schedule")
@patch("src.inference.next_race.get_last_completed_race_from_gold")
...
@patch("src.inference.next_race._storage")
...
@patch("src.models.cascade.predict.build_inference_frames")
@patch("src.models.cascade.predict.resolve_target_race")
